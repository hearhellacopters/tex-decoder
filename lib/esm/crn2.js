...
import { decodeBC1, decodeBC2, decodeBC3, } from './dxt';
import { decodeBC4, decodeBC5 } from './atc';
const CRN_FORMATS = {
    0: "cCRNFmtDXT1",
 ...
 */
export function getCRNMeta(data, mipmap_level) {
 ...
 */
export function decodeCRN(data, mipmap_level, keepCompressed) {
    if (!isArrayOrBuffer(data)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const header = new Header(data);
