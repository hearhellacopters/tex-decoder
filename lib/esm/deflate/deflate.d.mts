...
export declare function deflateResetKeep(strm: ZStream): number;
export declare function deflateReset(strm: ZStream): number;
export declare function deflateSetHeader(strm: ZStream, head: GZheader): number;
...
export declare function deflateSetDictionary(strm: ZStream, dictionary: Uint8Array): number;
export {};
