 ...
 */
export function decodeATI1(src, width, height) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATI(src, width, height, Do2) {
    if (Do2) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC4(src, width, height) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATI2(src, width, height) {
    return decodeBC5(src, width, height);
}
/**
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC5(src, width, height) {
    if (!isArrayOrBuffer(src)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const image = new Uint32Array(width * height);
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC(src, width, height, Do8bitMode) {
    if (Do8bitMode) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC8(src, width, height) {
    if (!isArrayOrBuffer(src)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const image = new Uint32Array(width * height);
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC4(src, width, height) {
    if (!isArrayOrBuffer(src)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const image = new Uint32Array(width * height);
