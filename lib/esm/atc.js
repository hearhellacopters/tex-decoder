 ...
 */
export function decodeATI1(data, width, height) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC4(data, width, height) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATI2(data, width, height) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC5(data, width, height) {
    if (!isArrayOrBuffer(data)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const image = new Uint32Array(width * height);
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC(data, width, height, Do8bitMode) {
    if (Do8bitMode) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC8(data, width, height) {
    if (!isArrayOrBuffer(data)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const image = new Uint32Array(width * height);
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC4(data, width, height) {
    if (!isArrayOrBuffer(data)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const image = new Uint32Array(width * height);
