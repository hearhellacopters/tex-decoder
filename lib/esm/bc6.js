 ...
 */
export function decodeBC6(data, width, height, unsigned) {
    if (unsigned) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC6S(data, width, height) {
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC6H(data, width, height) {
    if (!isArrayOrBuffer(data)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const BLOCK_WIDTH = 4;
