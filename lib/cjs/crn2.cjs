...
exports.decodeCRN = exports.getCRNMeta = void 0;
const dxt_js_1 = require("./dxt.cjs");
const atc_js_1 = require("./atc.cjs");
const CRN_FORMATS = {
    0: "cCRNFmtDXT1", //BC1
...
function decodeCRN(src, mipmap_level, keepCompressed) {
    ...
    if (keepCompressed == true || keepCompressed == undefined) {
        switch (header.format) {
            case 0: //BC1
                retval = (0, dxt_js_1.decodeBC1)(level.data, level.width, level.height);
                break;
            case 1: //BC2
                retval = (0, dxt_js_1.decodeBC2)(level.data, level.width, level.height);
                break;
            case 2: //BC3
                retval = (0, dxt_js_1.decodeBC3)(level.data, level.width, level.height);
                break;
            case 9: //BC4
                retval = (0, atc_js_1.decodeBC4)(level.data, level.width, level.height);
                break;
            case 3:
            case 4:
            case 5:
            ...
            case 7:
            case 8:
                retval = (0, atc_js_1.decodeBC5)(level.data, level.width, level.height);
                break;
            default:
                break;
        }
