...
exports.makePNG = exports.makePNG2 = exports.readPNG = exports.CRC32 = void 0;
//@FixImport
const index_js_1 = require("./deflate/index.js");
...
function readPNG(src) {
    ...
    const unzipped = (0, index_js_1.inflate)(zippeddata);
    var retval = unzipped;
    if (isBuffer(src)) {
 ...
 * @returns
 */
function makePNG2(src, width, height, noAlpha, issRGB) {
    ...
    var zipped_data = (0, index_js_1.deflate)(src, {
...
function makePNG(src, width, height, noAlpha, issRGB) {
    ...
    const newfile = new pngjs_1.PNG(options);
    if (issRGB) {
    ...
    return pngjs_1.PNG.sync.write(newfile, options);
}
