...
exports.decodePVRTCII2bit = exports.decodePVRTCII4bit = void 0;
 ...
 */
function decodePVRTCII4bit(data, width, height) {
...
exports.decodePVRTCII4bit = decodePVRTCII4bit;
/**
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
function decodePVRTCII2bit(data, width, height) {
    if (!isArrayOrBuffer(data)) {
        throw new Error(`Source data must be Uint8Array or Buffer`);
    }
    const num_blocks_x = Math.floor((width + 4 - 1) / 4);
...
exports.decodePVRTCII2bit = decodePVRTCII2bit;
//# sourceMappingURL=pvrtcii.js.map