...
const zlib_deflate = tslib_1.__importStar(require("./deflate.cjs"));
const zlib_inflate = tslib_1.__importStar(require("./inflate.cjs"));
...
const strings = tslib_1.__importStar(require("./strings.cjs"));
const messages_js_1 = require("./messages.cjs");
const zstream_js_1 = require("./zstream.cjs");
const gzheader_js_1 = require("./gzheader.cjs");
const toString = Object.prototype.toString;
/* Public constants ==========================================================*/
/* ===========================================================================*/
const constants_js_1 = require("./constants.cjs");
const { Z_NO_FLUSH, Z_SYNC_FLUSH, Z_FULL_FLUSH, Z_FINISH, Z_OK, Z_STREAM_END, Z_NEED_DICT, Z_STREAM_ERROR, Z_DATA_ERROR, Z_MEM_ERROR, Z_DEFAULT_COMPRESSION, Z_DEFAULT_STRATEGY, Z_DEFLATED } = constants_js_1.constants;
/**
 * new Deflate(options)
...
function deflate(input, options) {
    ...
    if (deflator.err) {
        throw deflator.msg || messages_js_1.msg[deflator.err];
    }
...
class Inflate {
    constructor(options) {
        ...
        this.header = new gzheader_js_1.GZheader();
...
function inflate(input, options) {
    ...
    // That will never happens, if you don't cheat with options :)
    if (inflator.err)
        throw inflator.msg || messages_js_1.msg[inflator.err];
