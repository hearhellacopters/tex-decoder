...
const zlib_deflate = __importStar(require("./deflate.js"));
const zlib_inflate = __importStar(require("./inflate.js"));
...
const zstream_js_1 = require("./zstream.js");
const gzheader_js_1 = require("./gzheader.js");
