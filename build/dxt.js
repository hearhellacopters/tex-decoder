...
export function decodeBC1(src, width, height) {
...
export function decodeDXT2(src, width, height) {
    return decodeDXTn2(src, width, height, true);
}
export function decodeBC2(src, width, height) {
...
;
export function decodeDXT4(src, width, height) {
...
export function decodeBC3(src, width, height) {
    return decodeDXTn3(src, width, height, false);
}
