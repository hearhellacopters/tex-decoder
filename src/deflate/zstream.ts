...
export class ZStream {
    ...
    adler: number;
    constructor() {
        this.input = <unknown>null as Uint8Array; // JS specific, because we have no pointers
        this.next_in = 0;
        ...
        this.output = <unknown>null as Uint8Array; // JS specific, because we have no pointers
        this.next_out = 0;
        ...
        this.state = <unknown>null as DeflateState;
