    ...
    while (sources.length) {
        ...
        for (const p in source) {
            if (Object.prototype.hasOwnProperty.call(source, p)) {
                (obj as { [key: string]: any })[p] = (source as { [key: string]: any })[p];
            }
        }
    }
...
export class Deflate {
    ...
    push(data: Uint8Array | Buffer, flush_mode: boolean | number): boolean {
        ...
        let status: number, _flush_mode: number | boolean;
     ...
     **/
    onData(chunk: Uint8Array | Buffer) {
        this.chunks.push(<unknown>chunk as Uint8Array);
    };
 ...
 * @param {options} options - options
 **/
export function deflate(input: Buffer | Uint8Array, options?: options_assigned) {
    const deflator = new Deflate(options as options);
 ...
 * @param {options} options - options
 **/
export function deflateRaw(input: Buffer | Uint8Array, options?: options_assigned) {
 ...
 * @param {options} options - options
 **/
export function gzip(input: Buffer | Uint8Array, options?: options_assigned) {
    options = options || {} as options;
    options.gzip = true;
    return deflate(input, options);
}
...
export class Inflate {
     ...
     **/
    push (data:Buffer|Uint8Array, flush_mode:number|boolean) {
        const strm = this.strm;
        const chunkSize = this.options.chunkSize;
 ...
 * ```
 **/
export function inflate(input:Buffer|Uint8Array|string, options?:options_assigned) {
    const inflator = new Inflate(options);

    inflator.push(<unknown> input as Uint8Array, true);
 ...
 * (header and adler32 crc).
 **/
export function inflateRaw(input:Buffer|Uint8Array|string, options?:options_assigned) {
    options = options || {} as options;
    options.raw = true;
 ...
 **/
export function ungzip(input:Buffer|Uint8Array|string, options?:options_assigned) {
    options = options || {} as options;
    return inflate(input, options);
}