...
function decode_atc_rgb4_block(
    data: Uint8Array, //&[u8] 
    outbuf: Uint32Array //&mut [u32]
    ) {
...
function decode_bc3_alpha(data:Uint8Array|Buffer, outbuf:Uint32Array, channel:number) {
 ...
 */
export function decodeATI1(src:Uint8Array|Buffer,width:number,height:number){
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATI(src:Uint8Array|Buffer,width:number,height:number,Do2?:boolean){
    if(Do2){
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC4(src:Uint8Array|Buffer,width:number,height:number){
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATI2(src:Uint8Array|Buffer,width:number,height:number){
    return decodeBC5(src,width,height)
}
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeBC5(src:Uint8Array|Buffer,width:number,height:number){
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC(src:Uint8Array|Buffer,width:number,height:number,Do8bitMode?:boolean){
    if(Do8bitMode){
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC8(src:Uint8Array|Buffer,width:number,height:number){
 ...
 * @returns ```Uint8Array``` or ```Buffer``` as RGBA
 */
export function decodeATC4(src:Uint8Array|Buffer,width:number,height:number){
